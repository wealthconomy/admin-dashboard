...
export default function NewBlogPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    authorAvatar: "", // Add authorAvatar to formData for preview
    publishToApp: true,
    publishToWeb: true,
  });
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      // Fallback to UI avatar if no author image was uploaded
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2.5">
              ...
              <div
                ...
                className="border border-dashed border-border/40 rounded-2xl p-6 flex flex-col items-center justify-center gap-2 bg-surface/30 hover:bg-surface/50 transition-colors cursor-pointer group min-h-[120px] relative overflow-hidden"
              >
                {formData.image ? (
            ...
            {!previewData ? (
              <div className="flex flex-col items-center justify-center h-[500px] text-center space-y-4 opacity-40">
                <div className="p-4 bg-surface rounded-full">
                  <Info className="h-8 w-8 text-slate" />
                </div>
                <div>
                  <p className="text-lg font-bold font-outfit text-dark">
                    Nothing to view yet
                  </p>
                  <p className="text-sm font-medium text-slate">
                    Fill the form and click preview to see it here
                  </p>
                </div>
              </div>
            ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-dark">
                        {previewData.author || "Unknown Author"}
                      </p>
